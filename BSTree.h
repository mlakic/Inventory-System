...
// -------------------------------------------------------------------------------------------
// Purpose: Due to template implementation Templatized BSTree class has holds
// implementations in .h file. it has templatized so all different type of movies can be executed
// Serves as a data structure to hold movies. holds item info in nodes
// -------------------------------------------------------------------------------------------
